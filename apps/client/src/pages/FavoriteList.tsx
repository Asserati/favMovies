...
import favoriteApi, { ListItem } from "../api/modules/favorite.api";
...
const FavoriteList = () => {
  const [medias, setMedias] = useState<ListItem[]>([]);
  const [filteredMedias, setFilteredMedias] = useState<ListItem[]>([]);
